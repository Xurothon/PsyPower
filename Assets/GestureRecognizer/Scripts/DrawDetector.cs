...
namespace GestureRecognizer
{
    ...
    /// </summary>
    public class DrawDetector : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler, IPointerDownHandler, IPointerUpHandler
    {
        ...
        [System.Serializable] public class ResultEvent : UnityEvent<RecognitionResult> { }
        ...
        {
            staffAnimator.SetBool("Active", true);
        }

        public void OnPointerUp(PointerEventData eventData)
        {
            staffAnimator.SetBool("Active", false);
        }
    }
}